...
export const Chart = ({ used = 0 }: { used: number }) => {
    ...
    return (
        <Card className="chart">
            ...
            <CardHeader className="chart-details flex flex-col items-center xl:items-start">
                <CardTitle className="chart-title whitespace-nowrap">Available Storage</CardTitle>
