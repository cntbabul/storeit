...
import { ActionType, AppwriteFile } from "@/types";
        ...
        return (
            <DialogContent className="shad-dialog button">
                <DialogHeader className="flex flex-col gap-3">
                    ...
                    {value === "share" && <ShareInput file={file} onInputChange={(newEmails) => setEmails([...(file.users || []), ...newEmails])} onRemove={handleRemoveUser} />}
                ...
                {['rename', 'delete', 'share'].includes(value) && (
                    <DialogFooter className="flex flex-col gap-3 md:flex-row">
                        <Button onClick={closeAllModals} className="modal-cancel-button" variant="outline">Cancel</Button>
                        <Button
